...
export default function AboutPage() {
  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden">
      <SpaceBackground />
      <div className="relative z-10 max-w-2xl w-full bg-background/80 backdrop-blur-md rounded-2xl shadow-xl p-8 mt-16 mb-16 border border-white/10">
        <button
          onClick={() => router.back()}
          className="mb-6 inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-black text-white font-semibold shadow hover:bg-black hover:text-white transition"
        >
        ...
        <h1 className="text-4xl font-extrabold text-center mb-4 text-white">About Scorpio</h1>
        <p className="text-lg text-center mb-6 text-white/80">
        ...
        <div className="flex flex-col items-center gap-4">
          <a
            ...
            className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-black text-white font-semibold shadow hover:bg-black hover:text-white transition"
          >
        ...
        <div className="mt-8 text-center text-xs text-gray-300">
          <span>Made by <span className="text-white">Rushil Mahadevu</span></span>
        </div>
      </div>
    </div>
  );
