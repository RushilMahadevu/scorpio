      ...
      <div className="container p-6 mx-auto space-y-8">
        ...
        {!profile?.organizationId ? (
          ...
          <Tabs defaultValue="overview" className="w-full">
            <div className="flex justify-start mb-6 border-b pb-4 mt-2">
              <TabsList>
                <TabsTrigger value="overview" className="cursor-pointer">Educators & Settings</TabsTrigger>
                <TabsTrigger value="students" className="cursor-pointer">Students & Portfolios</TabsTrigger>
              </TabsList>
            </div>
            ...
            <TabsContent value="students">
              <NetworkStudents organizationId={organization.id} teacherIds={networkMembers.map(m => m.uid)} />
            </TabsContent>
          </Tabs>
        )}
