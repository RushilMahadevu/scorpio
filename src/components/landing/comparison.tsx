    ...
    <section id="comparison" className="container mx-auto px-4 sm:px-6 py-16 md:py-32 relative">
      ...
      >
        <div className="text-center space-y-4 mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-extrabold tracking-tight">How Tutor <span className="text-primary italic">Helps</span></h2>
            ...
            <div className="grid grid-cols-5 bg-muted/30 border-b border-border/50 px-6 py-4 min-w-[600px]">
              ...
              <div className="col-span-1 text-center">
                <div className="inline-flex flex-col items-center gap-1">
                  <span className="text-xs font-black uppercase tracking-widest text-foreground">Tutor</span>
